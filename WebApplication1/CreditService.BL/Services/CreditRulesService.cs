...
public class CreditRulesService: ICreditService
{
    ...
    public async Task<List<ShortCreditDto>> GetAllCreditRules()
    {
        ...
        {
            Id = e.Id,
            AmountMax = new MoneyDto
            {
                Amount = e.AmountMax.Amount,
                Currency = e.AmountMax.Currency
            },
    ...
    public async Task<CreditDto> GetCreditRule(Guid id)
    {
        ...
        return new CreditDto
        {
            ...
            AmountMax = new MoneyDto
            {
                Amount = credit.AmountMax.Amount,
                Currency = credit.AmountMax.Currency
            },
            AmountMin = new MoneyDto
            {
                Amount = credit.AmountMax.Amount,
                Currency = credit.AmountMax.Currency
            },
